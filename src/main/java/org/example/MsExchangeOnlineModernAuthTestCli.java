...
@Command(name = "MsExchangeOnlineModernAuthTestCli", mixinStandardHelpOptions = true, version = "MsExchangeOnlineModernAuthTestCli", description = "")
class MsExchangeOnlineModernAuthTestCli implements Callable<Integer> {
    ...
    public Integer call() throws Exception {
        ...
        try {
            if (email != null) {
                System.out.println("Token received. Trying to access mailbox '"+email+"' for folder '"+imapFolder+"' over IMAP.");
    ...
    void accessMailbox(String email) throws Exception {
        ...
        try {
            ...
            Arrays.asList(folder.getMessages(1 , Math.max(5, folder.getMessageCount())))
